...
_LITHUANIAN_NAMES = [
    "Tomas", "Marta", "Andrius", "Kristina", "Lukas",
...
def _build_user_message(topic: str, viewpoint: Viewpoint) -> str:
    """Build the user message for persona synthesis LLM call."""
...
def synthesize_personas(topic: str, viewpoints: List[Viewpoint]) -> List[GeneratedPersona]:
    """
    Synthesize a GeneratedPersona for each enriched viewpoint via one LLM call each. [WIP] -> should be batched for better quality
    ...
    for i, vp in enumerate(viewpoints):
        ...
        # always pick the same name for same index to ensure consistency across runs
